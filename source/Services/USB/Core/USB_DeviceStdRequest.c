...
extern USB_SetupPacket_t __ControlRequest;
	...
	switch(__ControlRequest.bRequest)
	{
		...
		case REQUEST_GET_DESCRIPTOR:
		{
			...
			*/
			...
			if((__ControlRequest.bmRequestType == (REQUEST_DIRECTION_DEVICE_TO_HOST | REQUEST_TYPE_STANDARD | REQUEST_RECIPIENT_DEVICE)) ||
			   (__ControlRequest.bmRequestType == (REQUEST_DIRECTION_DEVICE_TO_HOST | REQUEST_TYPE_STANDARD | REQUEST_RECIPIENT_INTERFACE)))
			{
