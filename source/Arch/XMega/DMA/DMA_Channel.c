 ...
 *  File info: Driver for Atmel AVR XMega DMA channel.
...
/** @file Arch/XMega/DMA/DMA_Channel.c
 *  @brief Driver for Atmel AVR XMega DMA channel.
 *
 *  This file contains the implementation of the Atmel AVR XMega DMA channel driver.
 *
 *  @author Daniel Kampert
 */
