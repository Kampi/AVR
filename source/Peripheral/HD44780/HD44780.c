...
static void HD44780_ClearData(void)
{
			...
			GPIO_ClearPort(GET_PERIPHERAL(HD44780_FIRST), 0x0F << GET_INDEX(HD44780_FIRST));
		#else
			GPIO_Clear(GET_PERIPHERAL(HD44780_DB4), GET_INDEX(HD44780_DB4));
			GPIO_Clear(GET_PERIPHERAL(HD44780_DB5), GET_INDEX(HD44780_DB5));
			GPIO_Clear(GET_PERIPHERAL(HD44780_DB6), GET_INDEX(HD44780_DB6));
			GPIO_Clear(GET_PERIPHERAL(HD44780_DB7), GET_INDEX(HD44780_DB7));
		#endif
	#elif(defined(HD44780_USE_8BIT))
		#if(defined(HD44780_USE_BUS))
			GPIO_ClearPort(GET_PERIPHERAL(HD44780_FIRST), 0xFF);
		#else
			GPIO_Clear(GET_PERIPHERAL(HD44780_DB0), GET_INDEX(HD44780_DB0));
			GPIO_Clear(GET_PERIPHERAL(HD44780_DB1), GET_INDEX(HD44780_DB1));
			GPIO_Clear(GET_PERIPHERAL(HD44780_DB2), GET_INDEX(HD44780_DB2));
			GPIO_Clear(GET_PERIPHERAL(HD44780_DB3), GET_INDEX(HD44780_DB3));
			GPIO_Clear(GET_PERIPHERAL(HD44780_DB4), GET_INDEX(HD44780_DB4));
			GPIO_Clear(GET_PERIPHERAL(HD44780_DB5), GET_INDEX(HD44780_DB5));
			GPIO_Clear(GET_PERIPHERAL(HD44780_DB6), GET_INDEX(HD44780_DB6));
			GPIO_Clear(GET_PERIPHERAL(HD44780_DB7), GET_INDEX(HD44780_DB7));
...
/** @brief		Send a databyte to the LCD.
 *  @param Data	Databyte
 */
static void HD44780_WriteByte(const uint8_t Data)
{
		...
		#if(defined(HD44780_USE_BUS))
			HD44780_ClearData();
			GPIO_SetPort(GET_PERIPHERAL(HD44780_FIRST), ((Data & 0xF0) >> 0x04) << GET_INDEX(HD44780_FIRST));
		#else
			(Data & 0x10) ? GPIO_Set(GET_PERIPHERAL(HD44780_DB4), GET_INDEX(HD44780_DB4)) : GPIO_Clear(GET_PERIPHERAL(HD44780_DB4), GET_INDEX(HD44780_DB4));
			(Data & 0x20) ? GPIO_Set(GET_PERIPHERAL(HD44780_DB5), GET_INDEX(HD44780_DB5)) : GPIO_Clear(GET_PERIPHERAL(HD44780_DB5), GET_INDEX(HD44780_DB5));
			(Data & 0x40) ? GPIO_Set(GET_PERIPHERAL(HD44780_DB6), GET_INDEX(HD44780_DB6)) : GPIO_Clear(GET_PERIPHERAL(HD44780_DB6), GET_INDEX(HD44780_DB6));
			(Data & 0x80) ? GPIO_Set(GET_PERIPHERAL(HD44780_DB7), GET_INDEX(HD44780_DB7)) : GPIO_Clear(GET_PERIPHERAL(HD44780_DB7), GET_INDEX(HD44780_DB7));
		#endif
		...
		#if(defined(HD44780_USE_BUS))
			HD44780_ClearData();
			GPIO_SetPort(GET_PERIPHERAL(HD44780_FIRST), (Data & 0x0F) << GET_INDEX(HD44780_FIRST));
		#else
			(Data & 0x01) ? GPIO_Set(GET_PERIPHERAL(HD44780_DB4), GET_INDEX(HD44780_DB4)) : GPIO_Clear(GET_PERIPHERAL(HD44780_DB4), GET_INDEX(HD44780_DB4));
			(Data & 0x02) ? GPIO_Set(GET_PERIPHERAL(HD44780_DB5), GET_INDEX(HD44780_DB5)) : GPIO_Clear(GET_PERIPHERAL(HD44780_DB5), GET_INDEX(HD44780_DB5));
			(Data & 0x04) ? GPIO_Set(GET_PERIPHERAL(HD44780_DB6), GET_INDEX(HD44780_DB6)) : GPIO_Clear(GET_PERIPHERAL(HD44780_DB6), GET_INDEX(HD44780_DB6));
			(Data & 0x08) ? GPIO_Set(GET_PERIPHERAL(HD44780_DB7), GET_INDEX(HD44780_DB7)) : GPIO_Clear(GET_PERIPHERAL(HD44780_DB7), GET_INDEX(HD44780_DB7));
		#endif
		...
		#if(defined(HD44780_USE_BUS))
			HD44780_ClearData();
			GPIO_SetPort(GET_PERIPHERAL(HD44780_FIRST), Data);
		#else
			(Data & 0x01) ? GPIO_Set(GET_PERIPHERAL(HD44780_DB0), GET_INDEX(HD44780_DB0)) : GPIO_Clear(GET_PERIPHERAL(HD44780_DB0), GET_INDEX(HD44780_DB0));
			(Data & 0x02) ? GPIO_Set(GET_PERIPHERAL(HD44780_DB1), GET_INDEX(HD44780_DB1)) : GPIO_Clear(GET_PERIPHERAL(HD44780_DB1), GET_INDEX(HD44780_DB1));
			(Data & 0x04) ? GPIO_Set(GET_PERIPHERAL(HD44780_DB2), GET_INDEX(HD44780_DB2)) : GPIO_Clear(GET_PERIPHERAL(HD44780_DB2), GET_INDEX(HD44780_DB2));
			(Data & 0x08) ? GPIO_Set(GET_PERIPHERAL(HD44780_DB3), GET_INDEX(HD44780_DB3)) : GPIO_Clear(GET_PERIPHERAL(HD44780_DB3), GET_INDEX(HD44780_DB3));
			(Data & 0x10) ? GPIO_Set(GET_PERIPHERAL(HD44780_DB4), GET_INDEX(HD44780_DB4)) : GPIO_Clear(GET_PERIPHERAL(HD44780_DB4), GET_INDEX(HD44780_DB4));
			(Data & 0x20) ? GPIO_Set(GET_PERIPHERAL(HD44780_DB5), GET_INDEX(HD44780_DB5)) : GPIO_Clear(GET_PERIPHERAL(HD44780_DB5), GET_INDEX(HD44780_DB5));
			(Data & 0x40) ? GPIO_Set(GET_PERIPHERAL(HD44780_DB6), GET_INDEX(HD44780_DB6)) : GPIO_Clear(GET_PERIPHERAL(HD44780_DB6), GET_INDEX(HD44780_DB6));
			(Data & 0x80) ? GPIO_Set(GET_PERIPHERAL(HD44780_DB7), GET_INDEX(HD44780_DB7)) : GPIO_Clear(GET_PERIPHERAL(HD44780_DB7), GET_INDEX(HD44780_DB7));
...
static void HD44780_Reset(void)
{
	...
	#if(defined(HD44780_USE_BUS))
		GPIO_SetPort(GET_PERIPHERAL(HD44780_FIRST), 0x03 << GET_INDEX(HD44780_FIRST));
	#else
		GPIO_Clear(GET_PERIPHERAL(HD44780_DB0), GET_INDEX(HD44780_DB0));
		GPIO_Clear(GET_PERIPHERAL(HD44780_DB1), GET_INDEX(HD44780_DB1));
		GPIO_Clear(GET_PERIPHERAL(HD44780_DB2), GET_INDEX(HD44780_DB2));
		GPIO_Clear(GET_PERIPHERAL(HD44780_DB3), GET_INDEX(HD44780_DB3));
		GPIO_Set(GET_PERIPHERAL(HD44780_DB4), GET_INDEX(HD44780_DB4));
		GPIO_Set(GET_PERIPHERAL(HD44780_DB5), GET_INDEX(HD44780_DB5));
		GPIO_Clear(GET_PERIPHERAL(HD44780_DB6), GET_INDEX(HD44780_DB6));
		GPIO_Clear(GET_PERIPHERAL(HD44780_DB7), GET_INDEX(HD44780_DB7));
	#endif
	...
	for(uint8_t i = 0x00; i < 0x03; i++)
	{
		...
		#if(defined(HD44780_USE_BUS))
			__HD44780_Func &= ~HD44780_FUNC_8BIT;
			GPIO_SetPort(GET_PERIPHERAL(HD44780_FIRST), 0x02 << GET_INDEX(HD44780_FIRST));
		#else
			GPIO_Clear(GET_PERIPHERAL(HD44780_DB0), GET_INDEX(HD44780_DB0));
			GPIO_Clear(GET_PERIPHERAL(HD44780_DB1), GET_INDEX(HD44780_DB1));
			GPIO_Clear(GET_PERIPHERAL(HD44780_DB2), GET_INDEX(HD44780_DB2));
...
static Bool_t HD44780_IsBusy(void)
{
	...
	#if(defined(HD44780_USE_BUS))
		#if(defined(HD44780_USE_4BIT))
			GPIO_SetDirection(GET_PERIPHERAL(HD44780_FIRST), GET_INDEX(HD44780_FIRST) + 3, GPIO_DIRECTION_IN);
		#else
			GPIO_SetDirection(GET_PERIPHERAL(HD44780_FIRST), GET_INDEX(HD44780_FIRST) + 7, GPIO_DIRECTION_IN);
		#endif
	#else
		GPIO_SetDirection(GET_PERIPHERAL(HD44780_DB7), GET_INDEX(HD44780_DB7), GPIO_DIRECTION_IN);
	#endif
	...
	GPIO_Set(GET_PERIPHERAL(HD44780_RW), GET_INDEX(HD44780_RW));
			...
			GPIO_Set(GET_PERIPHERAL(HD44780_ENABLE), GET_INDEX(HD44780_ENABLE));
			_delay_us(1);
			Status = GPIO_ReadPort(GET_PERIPHERAL(HD44780_FIRST)) >> (GET_INDEX(HD44780_FIRST) + 3);
			GPIO_Clear(GET_PERIPHERAL(HD44780_ENABLE), GET_INDEX(HD44780_ENABLE));

			// Get the lower nibble
			GPIO_Set(GET_PERIPHERAL(HD44780_ENABLE), GET_INDEX(HD44780_ENABLE));
			_delay_us(1);
			GPIO_ReadPort(GET_PERIPHERAL(HD44780_FIRST));
			GPIO_Clear(GET_PERIPHERAL(HD44780_ENABLE), GET_INDEX(HD44780_ENABLE));
		#else
		#endif
	#else
		#if(defined(HD44780_USE_BUS))
			Status = GPIO_ReadPort(GET_PERIPHERAL(HD44780_FIRST)) >> 0x07;
		#else
			Status = GPIO_Read(GET_PERIPHERAL(HD44780_DB7), GET_INDEX(HD44780_DB7));
		#endif
	#endif
	...
	#if(defined(HD44780_USE_BUS))
		#if(defined(HD44780_USE_4BIT))
			GPIO_SetDirection(GET_PERIPHERAL(HD44780_FIRST), GET_INDEX(HD44780_FIRST) + 3, GPIO_DIRECTION_OUT);
		#else
			GPIO_SetDirection(GET_PERIPHERAL(HD44780_FIRST), GET_INDEX(HD44780_FIRST) + 7, GPIO_DIRECTION_OUT);
		#endif
	#else
		GPIO_SetDirection(GET_PERIPHERAL(HD44780_DB7), GET_INDEX(HD44780_DB7), GPIO_DIRECTION_OUT);
	#endif
...
void HD44780_Init(void)
{
	...
	// Configure the data pins as output
			...
			GPIO_SetPortDirection(GET_PERIPHERAL(HD44780_FIRST), 0xFF, GPIO_DIRECTION_OUT);
		#else
			GPIO_SetPortDirection(GET_PERIPHERAL(HD44780_FIRST), (0x01 << GET_INDEX(HD44780_FIRST)) | (0x01 << (GET_INDEX(HD44780_FIRST) + 1)) | (0x01 << (GET_INDEX(HD44780_FIRST) + 2)) | (0x01 << (GET_INDEX(HD44780_FIRST) + 3)) , GPIO_DIRECTION_OUT);
		#endif
	#else
		GPIO_SetDirection(GET_PERIPHERAL(HD44780_DB7), GET_INDEX(HD44780_DB7), GPIO_DIRECTION_OUT);
		GPIO_SetDirection(GET_PERIPHERAL(HD44780_DB6), GET_INDEX(HD44780_DB6), GPIO_DIRECTION_OUT);
		GPIO_SetDirection(GET_PERIPHERAL(HD44780_DB5), GET_INDEX(HD44780_DB5), GPIO_DIRECTION_OUT);
		GPIO_SetDirection(GET_PERIPHERAL(HD44780_DB4), GET_INDEX(HD44780_DB4), GPIO_DIRECTION_OUT);
		
		#if(defined(HD44780_USE_8BIT))
			GPIO_SetDirection(GET_PERIPHERAL(HD44780_DB3), GET_INDEX(HD44780_DB3), GPIO_DIRECTION_OUT);
			GPIO_SetDirection(GET_PERIPHERAL(HD44780_DB2), GET_INDEX(HD44780_DB2), GPIO_DIRECTION_OUT);
			GPIO_SetDirection(GET_PERIPHERAL(HD44780_DB1), GET_INDEX(HD44780_DB1), GPIO_DIRECTION_OUT);
			GPIO_SetDirection(GET_PERIPHERAL(HD44780_DB0), GET_INDEX(HD44780_DB0), GPIO_DIRECTION_OUT);
		#endif
	#endif
