 ...
 *  File info: Driver for Atmel AVR8 mega32 CPU.
...
/** @file Arch/AVR8/megaAVR/mega32/CPU/CPU.h
 *  @brief Driver for Atmel AVR8 mega32 CPU.
 *
 *  This file contains the prototypes and definitions for the Atmel AVR8 mega328 CPU driver.
 *
