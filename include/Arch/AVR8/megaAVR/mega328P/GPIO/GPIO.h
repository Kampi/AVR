 ...
 *  File info: Driver for Atmel AVR8 mega328P GPIO interface.
...
/** @file Arch/AVR8/megaAVR/mega328P/GPIO/GPIO.h
 *  @brief Driver for Atmel AVR8 mega328P GPIO interface.
 *
 *  This file contains the prototypes and definitions for the Atmel AVR8 mega328P GPIO driver.
 *
 ...
 */
  ...
  *  @return		I/O state
  */
 static inline Bool_t GPIO_ReadPort(PORT_t* Port) __attribute__ ((always_inline));
 static inline Bool_t GPIO_ReadPort(PORT_t* Port)
 {
	 return Port->IN;
 }
