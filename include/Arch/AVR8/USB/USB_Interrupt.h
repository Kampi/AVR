...
/** @file Arch/AVR8/USB/USB_Interrupt.h
 *  @brief Interrupt functions for AVR8 USB.
 *
 *  This file contains the implementation of the AVR8 USB driver interrupts.
 *
...
#define USB_INTERRUPT_H_
  ...
  */
 static inline Bool_t USBController_IsInterruptEnabled(const USB_InterruptType_t Interrupt) __attribute__ ((always_inline));
 static inline Bool_t USBController_IsInterruptEnabled(const USB_InterruptType_t Interrupt)
 {
	 switch(Interrupt)
	 {
		 /*
  ...
  *  @return		#TRUE if the interrupt source is enabled
  */
 static inline Bool_t USBController_CheckForInterrupt(const USB_InterruptType_t Interrupt) __attribute__ ((always_inline));
 static inline Bool_t USBController_CheckForInterrupt(const USB_InterruptType_t Interrupt)
 {
	 switch(Interrupt)
	 {
		 /*
