 ...
 *  File info: USB device controller definition for AVR8 MCUs.
...
/** @file Arch/AVR8/USB/USB_DeviceController.h
 *  @brief USB device definition for AVR8 MCUs.
 *
 *  This file contains the prototypes and definitions for AVR8 USB devices.
 *
