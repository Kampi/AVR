 ...
 *  File info: Driver for XMega system clock.
 ...
 *  @brief Driver for XMega clock system. 
 *
 *  This file contains the prototypes and definitions for the XMega clock system.
 *
...
#define SYSCLOCK_H_
 ...
 typedef enum
 {
	 ...
	 CLOCK_SOURCE_INT32KHZ = 0x02,			/**< 32 kHz internal oscillator */ 
 ...
 static inline void SysClock_Init(void)
 {
	 ...
	 #else
		 #warning "No valid F_CPU defined! Use default 2 MHz clock."
		 SysClock_EnableClock(CLOCK_SOURCE_INT2MHZ);
		 SysClock_SetClockSource(CLOCK_SOURCE_INT2MHZ);
	 #endif
 }
 ...
 static inline uint32_t SysClock_GetClockPer4(void)
 {
	 switch(CLK.PSCTRL >> 0x02)
	 {
		 case(0x00):
		 {
			 return SysClock_GetClock();
		 }
		 case(0x01):
		 {
			 return SysClock_GetClock() >> 0x01;
		 }
		 case(0x03):
		 {
			 return SysClock_GetClock() >> 0x02;
		 }
		 case(0x05):
		 {
			 return SysClock_GetClock() >> 0x03;
		 }
		 case(0x07):
		 {
			 return SysClock_GetClock() >> 0x04;
		 }
		 case(0x09):
		 {
			 return SysClock_GetClock() >> 0x05;
		 }
		 case(0x0B):
		 {
			 return SysClock_GetClock() >> 0x06;
		 }
		 case(0x0D):
		 {
			 return SysClock_GetClock() >> 0x07;
		 }
		 case(0x0F):
		 {
			 return SysClock_GetClock() >> 0x08;
		 }
		 case(0x11):
		 {
			 return SysClock_GetClock() >> 0x09;
		 }
		default:
		{
			// Invalid case
 ...
 static inline uint32_t SysClock_GetClockPer2(void)
 {
	 switch((CLK.PSCTRL & 0x03))
	 {
		 case(0x02):
		 {
			 return SysClock_GetClockPer4() >> 0x02;
		 }
		 case(0x03):
		 {
			 return SysClock_GetClockPer4() >> 0x01;
		 }
		 default:
		 {
			return SysClock_GetClockPer4();
		 }
	 }
 }
 ...
 static inline uint32_t SysClock_GetClockPer(void)
 {
	 switch(CLK.PSCTRL & 0x01)
	 {
		 case(0x00):
		 {
			 return SysClock_GetClockPer2();
		 }
		 case(0x01):
		 {
			 return SysClock_GetClockPer2() >> 0x01;
		 }
		 // Invalid case
		 default:
		 {
