 ...
 */
 ...
 typedef struct
 {
	 ...
	 uint8_t RepeatCount;					/**< Repeat count. Only needed if \ref DMA_TransferConfig_t.EnableRepeatMode is #true */
  ...
  *			NOTE: You have to call \ref DMA_Disable first!
  */
 ...
 {
	 DMA.CTRL = (DMA.CTRL & (~(0x03 << 0x02))) | (DoubleBuffer << 0x02);
 }
 ...
 {
	 DMA.CTRL = (DMA.CTRL & (~0x03)) | Priority;
 }
