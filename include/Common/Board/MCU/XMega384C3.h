 ...
 *  File info: MCU specific definitions and constants for the Atmel XMega384C3.
...
#ifndef XMEGA384C3_H_
#define XMEGA384C3_H_
 ...
 */
 ...
 /*
	DMA
 */
 #define DMA_CHANNEL									2							/**< DMA channel count for each controller */ 
