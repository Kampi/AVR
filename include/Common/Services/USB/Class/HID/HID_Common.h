...
#define HID_COMMON_H_
 ...
 /** @ingroup USB-HID
  *  USB HID class specific reports
  * NOTE: Please look here https://www.usb.org/sites/default/files/documents/hid1_11.pdf if you need more information */
 /*\@{*/
 typedef enum 
 {
 ...
 /** 
  * Standard mouse report definition
  *	NOTE: See https://usb.org/sites/default/files/documents/hid1_11.pdf for more information
  */
 typedef struct
 {
 ...
 /** 
  * Standard keyboard report definition
  *	NOTE: See https://usb.org/sites/default/files/documents/hid1_11.pdf for more information
  */
 typedef struct
 {
