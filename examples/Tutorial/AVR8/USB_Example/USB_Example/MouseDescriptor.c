...
const USB_StringDescriptor_t PROGMEM LANGID = LANG_TO_STRING_DESCRIPTOR(LANG_ENGLISH, SUBLANG_ARABIC_SAUDI_ARABIA);
...
int __Mouse_Ctrl_Ep_Size = MOUSE_CTRL_EP_SIZE;
