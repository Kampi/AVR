...
/** @} */ // end of DS1307
	...
	#define DS1307_I2C_INIT(Config)								I2CM_Init(Config)
	#define DS1307_I2C_WRITE(Data, Stop)						I2CM_WriteByte(&DS1307_INTERFACE, DS1307_ADDRESS, Data, Stop)
	#define DS1307_I2C_READ(Data, Stop)							I2CM_ReadByte(&DS1307_INTERFACE, DS1307_ADDRESS, Data, Stop)
	#define DS1307_I2C_WRITEREG(Length, Data, Stop)				I2CM_WriteBytes(&DS1307_INTERFACE, DS1307_ADDRESS, Length, Data, Stop)
	#define DS1307_I2C_READREG(Length, Data, Stop)				I2CM_ReadBytes(&DS1307_INTERFACE, DS1307_ADDRESS, Length, Data, Stop)
#else
