...
{
	SPIM_CHIP_SELECT(SSD1306_SS_PORT, SSD1306_SS_PIN);
	GPIO_Clear(SSD1306_DATA_CMD_PORT, SSD1306_DATA_CMD_PIN);
	SPIM_TRANSMIT(DISPLAY_INTERFACE, Data);
	SPIM_CHIP_DESELECT(SSD1306_SS_PORT, SSD1306_SS_PIN);
}
...
void Display_Init(SPIM_Config_t* Config)
{
	...
	GPIO_SetDirection(SSD1306_DATA_CMD_PORT, SSD1306_DATA_CMD_PIN, GPIO_DIRECTION_OUT);
	GPIO_Set(SSD1306_DATA_CMD_PORT, SSD1306_DATA_CMD_PIN);
	
	// Set display reset as output in high state
	GPIO_SetDirection(SSD1306_RESET_PORT, SSD1306_RESET_PIN, GPIO_DIRECTION_OUT);
	GPIO_Set(SSD1306_RESET_PORT, SSD1306_RESET_PIN);
	
	// Set display SS as output in high state
	GPIO_SetDirection(SSD1306_SS_PORT, SSD1306_SS_PIN, GPIO_DIRECTION_OUT);
	GPIO_Set(SSD1306_SS_PORT, SSD1306_SS_PIN);
