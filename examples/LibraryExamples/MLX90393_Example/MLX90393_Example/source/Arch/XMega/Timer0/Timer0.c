 ...
 *  File info: Driver for XMega Timer type 0.
...
/** @file Arch/XMega/Timer0/Timer0.c
 *  @brief Driver for XMega Timer type 0.
 *
 *  This contains the implementation of the XMega Timer0 driver.
 *
 *  @author Daniel Kampert
 */
...
void Timer0_WaveInit(Timer0_WaveConfig_t* Config)
{
	...
	GPIO_SetDirection(Port, Pin, GPIO_DIRECTION_OUT);
	GPIO_SwitchInvert(Port, Pin, Config->EnableInvert);
