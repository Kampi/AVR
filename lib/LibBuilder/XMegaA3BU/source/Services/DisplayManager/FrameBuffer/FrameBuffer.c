 ...
 *  File info: Simple frame buffer for displays.
...
/** @file Common/Services/DisplayManager/FrameBuffer/FrameBuffer.c
 *  @brief Simple frame buffer for displays.
 *
...
#include "Common/Services/DisplayManager/FrameBuffer/FrameBuffer.h"
